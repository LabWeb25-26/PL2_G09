...
namespace Dcar.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdMarca,NomeMarca")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMarca,NomeMarca")] Marca marca)
        {
            if (id != marca.IdMarca)
            {
                return NotFound();
