...
namespace Dcar.Data
{
    // ALTERAÇÃO AQUI: Adicionado <Utilizador>
    public class ApplicationDbContext : IdentityDbContext<Utilizador>
    {
        ...
        // =========================================================
        // 2. CONFIGURAÇÃO DO MODELO (Mapeamento SQL)
        // =========================================================
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            // ⚠️ IMPORTANTE: Garante que as tabelas de Login (Identity) são criadas
            base.OnModelCreating(modelBuilder);

            // Configuração das tuas tabelas personalizadas
