...
namespace MarketplaceVeiculos.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public MarcasController(MarketplaceContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id_marca,nome_marca")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id_marca,nome_marca")] Marca marca)
        {
